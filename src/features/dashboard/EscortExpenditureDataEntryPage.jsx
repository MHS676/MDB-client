...
const EscortExpenditureDataEntryPage = () => {
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Create, edit, and maintain escort expenditure records in the Data Input Core workspace.
            </p>
          </div>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-slate-500">Update or remove saved escort expenditure entries.</p>
          </div>
          {statusMessage ? <p className="text-sm text-emerald-600">{statusMessage}</p> : null}
        </div>

        <label className="mb-4 flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-600">
        ...
        <ExpenditureTable records={filteredRecords} onEdit={handleEdit} onDelete={handleDelete} loading={isLoading} />
      </div>
    </div>
  );
};

export default EscortExpenditureDataEntryPage;
